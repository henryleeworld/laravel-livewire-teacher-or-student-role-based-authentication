    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}" x-data="{role_id: 2}">
            ...
            <div class="mt-4" x-show="role_id == 2">
                <x-label for="student_address" value="{{ __('Address') }}" />
                <x-input id="student_address" class="block mt-1 w-full" type="text" :value="old('student_address')" name="student_address" />
            </div>

            <div class="mt-4" x-show="role_id == 2">
                <x-label for="student_licence_number" value="{{ __('Licence Number') }}" />
                <x-input id="student_licence_number" class="block mt-1 w-full" type="text" :value="old('student_licence_number')" name="student_licence_number" />
            </div>
